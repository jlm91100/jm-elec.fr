...
export default function HomePage() {
  ...
  return (
    <Layout>
      <SEOHead
        title="JM-ELEC 91 — Électricien professionnel en Essonne et Île-de-France"
        description="Électricien professionnel certifié IRVE en Essonne et Île-de-France. Remplacement de tableau, dépannage, mise en conformité, borne de recharge. 10 ans d'expérience, assurance décennale. Devis gratuit sous 24 h."
      />
